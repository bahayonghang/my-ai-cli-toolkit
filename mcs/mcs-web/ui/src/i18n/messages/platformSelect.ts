export const enPlatformSelectMessages = {
  ...
  "platformSelect.subtitle":
    "See which platforms share a local skills library, review platform-specific extras, and jump straight into local installs or the npx skills workspace.",
...
> = {
  ...
  "platformSelect.title": "MyClaude Skills",
  "platformSelect.subtitle":
    "查看哪些平台共享同一个本地技能库，核对平台专属扩展入口，并直接进入本地安装或 npx skills 工作区。",
