...
class SkillListView(ListView):
    ...
    class SkillHighlighted(Message):
        """技能高亮变更消息"""
        def __init__(self, skill: Optional[ExternalSkillInfo]) -> None:
            super().__init__()
            self.skill = skill
    ...
    def __init__(self, id: str | None = None) -> None:
        ...
        self._last_highlighted: Optional[SkillItem] = None
    ...
    def get_focused_skill(self) -> Optional[ExternalSkillInfo]:
        """获取当前高亮的技能
