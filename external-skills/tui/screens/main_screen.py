...
from textual.widgets import Static, Input, ProgressBar, RichLog
...
class MainScreen(Screen):
    ...
    def __init__(self, platform: str = "claude") -> None:
        ...
        self._manager: Optional[ExternalSkillManager] = None
    ...
    def _get_focused_skill(self) -> Optional[ExternalSkillInfo]:
        """获取当前高亮的技能"""
