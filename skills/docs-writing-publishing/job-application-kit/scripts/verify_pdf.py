...
Ported from MadsLorentzen/ai-job-search (tools/verify_pdf.py), MIT License.
Copyright (c) Mads Lorentzen. Adaptations for job-application-kit:
docstring and install hints only; verification logic unchanged.
"""
