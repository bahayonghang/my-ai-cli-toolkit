...
Impact cards, vertical timeline, RCA callout, action item table, and prevention checklist. For tables, see `tables-cookbook.md` recipe 3 (risk register) for action items with owner/due/status. For charts, see `charts-cookbook.md` — recipe 6 (bullet) for MTTR vs target, recipe 8 (stacked progress) for impact share by region/segment, recipe 1 (vertical bar) for error-rate vs baseline.
...
<section id="impact" aria-labelledby="impact-title">
  ...
  <div class="callout danger">
    <strong>Sev 2</strong> — 24 min user-visible degradation, 18% of EU traffic
    affected.
  </div>
</section>
<section id="timeline" aria-labelledby="timeline-title">
  ...
  <ol class="timeline">
    ...
    <li>
      <strong>14:11</strong> — Root cause identified: stale connection pool.
    </li>
