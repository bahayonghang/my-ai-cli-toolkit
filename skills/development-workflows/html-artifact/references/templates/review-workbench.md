...
## Interaction pattern
Filter by severity, jump from file map to finding, copy individual review comments, and collapse low-severity items.
...
<section id="findings" aria-labelledby="findings-title">
  ...
  <div class="summary-grid">
    <article class="card">
      <p><span class="status-pill critical">Blocker</span> <code>src/auth.ts:42</code></p>
...
<section id="coverage" aria-labelledby="coverage-title">
  ...
  <ul><li>No regression test for the auth bypass path above.</li></ul>
</section>
```
