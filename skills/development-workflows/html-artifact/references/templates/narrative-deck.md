...
Arrow-key navigation, toggle notes, and print/export hint. See `interaction-cookbook.md` — recipe 10 (keyboard shortcuts) for j/k/?/Esc navigation, recipe 4 (tabs) when a slide needs to switch between alternate views (chart vs data table), recipe 5 (`<details>` disclosure) for speaker notes that should print but stay collapsed on screen.
...
<section class="slide" id="slide-1" aria-labelledby="slide-1-title">
  ...
  <details>
    ...
    <p>Talking beats: framing, contrast, one data point.</p>
  </details>
</section>
<section class="slide" id="slide-2" aria-labelledby="slide-2-title">
  ...
  <ul>
    <li>Data point or quote (cite source).</li>
  </ul>
</section>
```
