...
## Interaction pattern
Perform local validation only, copy as JSON/Markdown/diff, reset sample data, and support keyboard-first form navigation.
...
<section id="editor" aria-labelledby="editor-title">
  ...
  <div class="callout"><strong>Local-only:</strong> validation and export run in this page; no network requests are made.</div>
