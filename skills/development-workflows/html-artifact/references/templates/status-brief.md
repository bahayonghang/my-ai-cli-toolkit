...
## Core components
Metric cards, status lanes, timeline, risk table, and asks panel.
...
<section id="metrics" aria-labelledby="metrics-title">
  ...
  <div class="summary-grid">
    <article class="card"><h3 class="card-title">P95 latency (ms)</h3><p>184 <span class="status-pill success">Under 250 target</span></p></article>
    <article class="card"><h3 class="card-title">Error rate (%)</h3><p>0.42 <span class="status-pill warning">Above 0.30 target</span></p></article>
  </div>
</section>
<section id="lanes" aria-labelledby="lanes-title">
  <h2 id="lanes-title">Shipped / slipped / blocked</h2>
  <div class="summary-grid">
    <article class="card"><h3 class="card-title">Shipped</h3><ul><li>Feature X (2026-05-19)</li></ul></article>
    <article class="card"><h3 class="card-title">Slipped</h3><ul><li>Migration Y, new ETA 2026-06-02</li></ul></article>
    <article class="card"><h3 class="card-title">Blocked</h3><ul><li>Audit Z <span class="status-pill danger">External</span></li></ul></article>
  </div>
</section>
```
