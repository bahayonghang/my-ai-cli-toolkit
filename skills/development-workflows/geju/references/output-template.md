...
Use this template when the user wants the design space opened up and conservative local thinking challenged. For short prompts, compress the structure instead of forcing every section.
