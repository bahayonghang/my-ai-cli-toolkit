...
Use this template when a proposal needs to be grounded, shrunk into a proof point, or pressure-tested for feasibility. For short prompts, compress this into a few tight paragraphs while preserving the landing judgment, first move, verification, and stop rule.

```markdown
# Landing Judgment: <topic>
