...
class SkillManager:
    def __init__(
        ...
        Args:
            target: Target platform (claude, codex, gemini, qwen, antigravity, windsurf, kiro, trae, opencode, iflow)
...
def list_skills(
    target: str = typer.Option(
        ...
        "--target",
        "-t",
        help="Target platform (claude, codex, gemini, qwen, antigravity, windsurf, kiro, trae, opencode, iflow)",
    ),
