...
npx skills add https://github.com/hyf0/vue-skills --skill vue-best-practices -g -y
```

```shell
# Remotion 视频创建最佳实践（使用 React 以编程方式创建视频的动画、音频和资源管理指南）
npx skills add https://github.com/remotion-dev/skills --skill remotion-best-practices -g -y
```

```shell
# Vue.js 官方 AI 技能集（Vue 核心团队维护的 AI 辅助开发技能）
npx skills add vuejs-ai/skills -g -y
```
...
npx skills add jeffallan/claude-skills -g -y
```
