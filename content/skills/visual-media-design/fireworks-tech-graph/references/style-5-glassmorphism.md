...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 600"
  ...
  <style>
    /* Use local/system fonts only; avoid remote @import so rsvg-convert stays portable */
    text { font-family: 'Inter', -apple-system, 'Segoe UI', 'Helvetica Neue', Arial, sans-serif; fill: #f0f6fc; }
  </style>
  <defs>
