...
metadata:
  ...
  tags:
    ...
    - transitions
    - react
argument-hint: "[interaction-type-or-description]"
...
|-------|-------------|---------------------|
| Microinteraction | Button states, form feedback, toasts, navigation indicators | `references/microinteraction-patterns.md` |
| Scroll Animation | Parallax, reveal, scroll-linked, sticky sections | `references/scroll-animations.md` |
| Complex Animation | GSAP timelines, page transitions, orchestration, spring physics | `references/animation-libraries.md` |
| Quick Polish | Simple hover/tap/focus states, CSS transitions | None (use SKILL.md inline patterns) |
...
```tsx
function RippleButton({ children, onClick }: { children: React.ReactNode; onClick?: React.MouseEventHandler<HTMLButtonElement> }) {
