...
2. Before writing code, scan the repository to understand the context the spec lands in. Identify the files that will change. Respect any existing `AGENTS.md` guidance in scope.
