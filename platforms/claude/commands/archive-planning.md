...
This command archives by **moving** these files. Do not copy them and do not leave the active root-level planning files behind after a successful archive.

## Execution Rules

1. Treat the current working directory as the project root.
2. Read the optional command argument as a single feature name:
